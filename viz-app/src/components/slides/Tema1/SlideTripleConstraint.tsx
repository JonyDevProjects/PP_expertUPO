...
const steps = [
    {
        id: 'intro',
        text: "La gestión de proyectos es el arte de equilibrar restricciones para alcanzar un objetivo único."
    },
    {
        id: 'functions',
        text: "Sus funciones principales son cuatro: Planificar la estrategia, Organizar los recursos, Dirigir al equipo e inspirarlo, y Controlar los resultados."
    },
    {
        id: 'restrictions',
        text: "Todo gira en torno a la Triple Restricción: Alcance, Tiempo y Coste. Si tocas uno, afectas a la Calidad. Es un equilibrio constante, un 'trade-off'."
    },
    {
        id: 'workflow',
        text: "El flujo de trabajo es cíclico pero estructurado en grupos de procesos: Iniciación, Planificación, Ejecución, Control y Cierre."
    },
    {
        id: 'curves',
        text: "No todas las fases consumen lo mismo. La curva de actividad muestra que la Ejecución es la que más recursos demanda, mientras que el Monitoreo es constante."
    },
    {
        id: 'areas',
        text: "El PMBOK define Áreas de Conocimiento clave, como la Integración, el Alcance, el Tiempo o los Costes, que debemos gestionar transversalmente."
    },
    {
        id: 'matrix',
        text: "Finalmente, la Matriz de Procesos cruza el 'Qué' (Áreas) con el 'Cuándo' (Grupos de Procesos) para darnos el mapa completo de la gestión."
    }
];
...
const SlideTripleConstraint = ({ autoPlay }: { autoPlay?: boolean }) => {
    ...
    // Guided Tour Logic: Auto-switch tabs based on TTS step
    useEffect(() => {
        if (!activeStep) return;

        // Define mapping from step ID to tab ID
        ...
        if (stepToTab[activeStep]) {
            setActiveTab(stepToTab[activeStep]);
        }
    }, [activeStep]);
