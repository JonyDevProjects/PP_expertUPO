...
const steps = [
    {
        id: 'pm-profile',
        text: "El Director de Proyecto es el equilibrista que gestiona tanto la técnica como a las personas. Pasa el 90% de su tiempo comunicando."
    },
    {
        id: 'roles',
        text: "Sus roles son clave: Liderar al equipo, gestionar a los interesados, equilibrar la triple restricción y comunicar el progreso."
    },
    {
        id: 'success-failure',
        text: "El éxito del proyecto depende de procesos sólidos y objetivos claros. El fracaso, a menudo, de la falta de apoyo directivo o una mala planificación."
    }
];
        ...
        <div className="animate-fade-in space-y-8">
            ...
            >
                <div className="flex flex-col xl:flex-row gap-8">
                    {/* The PM Profile */}
                    <div className={`flex-1 ${getFocusClass('pm-profile')}`}>
                        <div className="bg-indigo-50 dark:bg-indigo-900/10 p-6 rounded-xl border border-indigo-100 dark:border-indigo-800 h-full">
                            <div className="flex justify-center mb-4">
                                <div className="w-20 h-20 bg-indigo-600 rounded-full flex items-center justify-center text-white shadow-md">
                                    <Users size={40} />
                                </div>
                            </div>
                    ...
                    <div className={`flex-1 ${getFocusClass('roles')}`}>
                        <div className="bg-surface p-6 rounded-xl border border-border flex flex-col justify-between h-full shadow-sm">
                            <div>
                    ...
                    {/* Success vs Failure */}
                    <div className={`flex-1 ${getFocusClass('success-failure')}`}>
                        <div className="space-y-4 h-full flex flex-col justify-center">
                            <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border-l-4 border-green-500 shadow-sm">
                            ...
                            <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg border-l-4 border-red-500 shadow-sm">
