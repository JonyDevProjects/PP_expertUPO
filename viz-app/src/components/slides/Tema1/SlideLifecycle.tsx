...
const steps = [
    {
        id: 'intro',
        text: "El desarrollo de un proyecto se refiere al ciclo de vida técnico."
    },
    {
        id: 'phases',
        text: "El ciclo de vida se desarrolla atraves de Procesos Productivos como: Conceptualización, Planificación y Diseño, Construcción, Entrega y Cierre."
    },
    {
        id: 'methodologies', // Fixed typo
        text: "Las metodologías, como Waterfall o Ágil (SCRUM), nos dan las herramientas para gestionar este trabajo de forma predecible o adaptativa."
    },
    {
        id: 'gantt',
...
const SlideLifecycle = ({ autoPlay, onAudioComplete }: { autoPlay?: boolean; onAudioComplete?: () => void }) => {
    ...
    const getFocusClass = (stepId: string) => {
        ...
        return activeStep === stepId
            ? "transition-all duration-500 opacity-100 scale-[1.01] ring-2 ring-indigo-400/50 rounded-xl shadow-lg z-20 bg-surface"
    ...
    return (
        <div className="animate-fade-in space-y-8">
            ...
            >
                ...
                {/* Methodologies */}
                <div className={`${getFocusClass('methodologies')} bg-background p-6 rounded-xl border border-border`}>
                ...
                <div className={`${getFocusClass('gantt')} mt-8 pt-6 border-t border-border`}>
                    ...
                    <div className="bg-surface dark:bg-slate-900 rounded-xl p-6 overflow-hidden shadow-inner border border-border dark:border-slate-800">
                        <div className="min-w-[500px] overflow-x-auto">
                            ...
                            <div className="space-y-4 relative">
                                ...
                                {/* Row: Seguimiento */}
                                <div className="grid grid-cols-[100px_1fr] gap-4 items-center group relative z-10">
                                    <div className="text-right text-xs font-medium text-amber-600 dark:text-amber-300 leading-tight">Control <br /></div>
                                    <div className="h-7 bg-slate-100 dark:bg-slate-800/50 rounded-lg relative w-full overflow-hidden">
