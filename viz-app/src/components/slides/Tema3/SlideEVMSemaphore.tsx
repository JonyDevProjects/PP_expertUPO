...
import { TrendingUp, DollarSign, Clock, AlertTriangle, CheckCircle, ArrowDown, ArrowUp, History, Zap } from 'lucide-react';
import { Card } from '../../ui/Card';

const SlideEVMSemaphore = () => {
    // Inputs
            ...
            <div className="bg-slate-900 text-white p-6 rounded-xl shadow-lg border-l-4 border-yellow-400">
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div>
                        ...
                        <p className="text-slate-300 mt-1">Gestión del Valor Ganado: Simulador de Salud del Proyecto</p>
                    </div>
