...
import { Network, SlidersHorizontal, AlertTriangle } from 'lucide-react';
import { Card } from '../../ui/Card';

const SlideCriticalPath = () => {
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            {/* Header */}
            <div className="bg-slate-900 text-white p-6 rounded-xl shadow-lg border-b-4 border-red-500">
                <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                    <div>
                        <h2 className="text-2xl font-bold flex items-center gap-3 text-white">
                            <Network className="w-8 h-8 text-red-500" />
                            Ruta Crítica (CPM) vs. Holgura
                        </h2>
                        <p className="text-slate-400 mt-1">Gestión de Prioridades: ¿Qué tareas no pueden esperar?</p>
                    </div>
                </div>
            </div>
            ...
            <Card className="p-2 md:p-8 overflow-hidden">
                ...
                <div className="relative h-[300px] w-full bg-slate-50 dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700 p-4">
                    ...
                    <div className="absolute top-10 left-0 w-full flex items-center px-4">
                    ...
                    <div className="absolute top-40 left-0 w-full flex items-center px-4">
