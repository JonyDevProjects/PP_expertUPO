...
const SlideOptimization = () => {
    return (
        <SlideContainer title="4. Optimización (Compresión)">
            <div className="min-h-[600px] mb-8">
                <CrashingVsFastTracking />
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-rose-50 dark:bg-rose-900/20 p-6 rounded-xl border border-rose-100 dark:border-rose-900/50">
